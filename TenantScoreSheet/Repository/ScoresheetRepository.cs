                ...
                if (dt.Rows.Count > 0)
                {
                    foreach (DataRow row in dt.Rows)
                    {
                        Scoresheet Objuser = new()
                        {
                            ...
                            MonthlyRent = System.Convert.IsDBNull(row["MonthlyRent"]) == true ? null : Convert.ToInt32(row["MonthlyRent"]),
                            
                            Section8Rent = System.Convert.IsDBNull(row["Section8Rent"]) == true ? null : Convert.ToInt32(row["Section8Rent"]), //Convert.ToString(row["Section8Rent"]),
                            StandardDepositProperty = System.Convert.IsDBNull(row["StandardDepositProperty"]) == true ? null : Convert.ToInt32  (row["StandardDepositProperty"]),
                            ...
                            PaystubRecent = System.Convert.IsDBNull(row["PaystubRecent"]) == true ? null : Convert.ToDouble(row["PaystubRecent"]) ,
                            YTD_Earnings = System.Convert.IsDBNull(row["YTD_Earnings"]) == true ? null: Convert.ToInt32(row["YTD_Earnings"]), // Convert.ToString(row[""]),
                            PaystubRecentMonthly = System.Convert.IsDBNull(row["PaystubRecentMonthly"]) == true ? null : Convert.ToInt32(row["PaystubRecentMonthly"]),
                             
                            BankStatement =  System.Convert.IsDBNull(row["BankStatement"]) == true ? null : Convert.ToInt32(row["BankStatement"]),
                            secondPayStub = System.Convert.IsDBNull(row["SecondPayStub"]) == true ? null : Convert.ToDouble(row["SecondPayStub"]),
                            BankStatementMonthly = System.Convert.IsDBNull(row["BankStatementMonthly"]) == true ? null : Convert.ToInt32(row["BankStatementMonthly"]),
                            xRent = System.Convert.IsDBNull(row["xRent"]) == true ? null : Convert.ToInt32  (row["xRent"]),
                            ...
                            CreditScore = System.Convert.IsDBNull(row["CreditScore"]) == true ? null : Convert.ToInt32  (row["CreditScore"]),
                            CreditScorePoints = System.Convert.IsDBNull(row["CreditScorePoints"]) == true ? null : Convert.ToInt32  (row["CreditScorePoints"]),
                            ...
                            CreditScoreAvailablePoints = System.Convert.IsDBNull(row["CreditScoreAvailablePoints"]) == true ? null : Convert.ToInt32    (row["CreditScoreAvailablePoints"]),
                            AccountPastDue60Days = System.Convert.IsDBNull(row["AccountPastDue60Days"]) == true ? null : Convert.ToInt32    (row["AccountPastDue60Days"]),
                            CollectionAccounts = System.Convert.IsDBNull(row["CollectionAccounts"]) == true ? null : Convert.ToInt32    (row["CollectionAccounts"]),
                            CollectionAccountsPoints = System.Convert.IsDBNull(row["CollectionAccountsPoints"]) == true ? null : Convert.ToInt32    (row["CollectionAccountsPoints"]),
                            MedicalCollections = System.Convert.IsDBNull(row["MedicalCollections"]) == true ? null : Convert.ToInt32    (row["MedicalCollections"]),
                            ...
                            PropertyRelatedHousingRecordPoints = System.Convert.IsDBNull(row["PropertyRelatedHousingRecordPoints"]) == true ? null : Convert.ToInt32    (row["PropertyRelatedHousingRecordPoints"]),
                            ...
                            LiensRepossessionsPoints = System.Convert.IsDBNull(row["LiensRepossessionsPoints"]) == true ? null : Convert.ToInt32    (row["LiensRepossessionsPoints"]),
                            EvectionHistory = System.Convert.IsDBNull(row["EvectionHistory"]) == true ? null : Convert.ToDateTime(row["EvectionHistory"]),
                            EvectionHistoryPoints = System.Convert.IsDBNull(row["EvectionHistoryPoints"]) == true ? null : Convert.ToInt32  (row["EvectionHistoryPoints"]),
                            Class1Felonies = System.Convert.IsDBNull(row["Class1Felonies"]) == true ? null : Convert.ToBoolean(row["Class1Felonies"]),
                            Class1FeloniesPoints = System.Convert.IsDBNull(row["Class1FeloniesPoints"]) == true ? null : Convert.ToInt32    (row["Class1FeloniesPoints"]),
                            Class2Felonies = System.Convert.IsDBNull(row["Class2Felonies"]) == true ? null : Convert.ToDateTime(row["Class2Felonies"]),
                            Class2FeloniesPoints = System.Convert.IsDBNull(row["Class2FeloniesPoints"]) == true ? null : Convert.ToInt32    (row["Class2FeloniesPoints"]),
                            Class1Misdemeaners = System.Convert.IsDBNull(row["Class1Misdemeaners"]) == true ? null : Convert.ToDateTime(row["Class1Misdemeaners"]),
                            Class1MisdemeanersPoints = System.Convert.IsDBNull(row["Class1MisdemeanersPoints"]) == true ? null : Convert.ToInt32    (row["Class1MisdemeanersPoints"]),
                            Class2Misdemeaners = System.Convert.IsDBNull(row["Class2Misdemeaners"]) == true ? null : Convert.ToDateTime(row["Class2Misdemeaners"]),
                            Class2MisdemeanersPoints = System.Convert.IsDBNull(row["Class2MisdemeanersPoints"]) == true ? null : Convert.ToInt32    (row["Class2MisdemeanersPoints"]),
                            DepositApproved = System.Convert.IsDBNull(row["DepositApproved"]) == true ? null : Convert.ToBoolean(row["DepositApproved"]),
                            DepositToHold = System.Convert.IsDBNull(row["DepositToHold"]) == true ? null : Convert.ToInt32(row["DepositToHold"]),
                            ...
                            PetApprovedLandlordReferance1 = System.Convert.IsDBNull(row["PetApprovedLandlordReferance1"]) == true ? null : Convert.ToInt32      (row["PetApprovedLandlordReferance1"]),
                            PetApprovedLandlordReferance2 = System.Convert.IsDBNull(row["PetApprovedLandlordReferance2"]) == true ? null : Convert.ToInt32  (row["PetApprovedLandlordReferance2"]),
                            NoOfCatsCompanion = System.Convert.IsDBNull(row["NoOfCatsCompanion"]) == true ? null : Convert.ToBoolean(row["NoOfCatsCompanion"]),
                            NoOfCatsCompanions = System.Convert.IsDBNull(row["NoOfCatsCompanions"]) == true ? null : Convert.ToInt32(row["NoOfCatsCompanions"]),
                            NoOfCatsCompanionPoints = System.Convert.IsDBNull(row["NoOfCatsCompanionPoints"]) == true ? null : Convert.ToInt32(row["NoOfCatsCompanionPoints"]),
                            ...
                            NoOfLargeDogsCompanions = System.Convert.IsDBNull(row["NoOfLargeDogsCompanions"]) == true ? null : Convert.ToInt32  (row["NoOfLargeDogsCompanions"]),
                            NoOfLargeDogsCompanionPoints = System.Convert.IsDBNull(row["NoOfLargeDogsCompanionPoints"]) == true ? null : Convert.ToInt32(row["NoOfLargeDogsCompanionPoints"]),
                            ...
                            NoOfSmallDogsCompanions = System.Convert.IsDBNull(row["NoOfSmallDogsCompanions"]) == true ? null : Convert.ToInt32(row["NoOfSmallDogsCompanions"]),
                            NoOfSmallDogsCompanionPoints = System.Convert.IsDBNull(row["NoOfSmallDogsCompanionPoints"]) == true ? null : Convert.ToInt32(row["NoOfSmallDogsCompanionPoints"]),
